...
class Physical_Vehicle_Link:
    ...
    def _resolve_references(self, id_lookup):
        if self.vehicle_connector_pin_refs is not None:
            for vehicle_connector_pin_ref in self.vehicle_connector_pin_refs:
                vehicle_connector_pin_ref.vehicle_connector_pin = id_lookup[vehicle_connector_pin_ref.id_ref]

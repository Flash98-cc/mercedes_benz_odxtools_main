...
# used matching the received value in a request message
# request_byte_position, byte_length are used to define the position and the length of the value within the request PDU
# for more details, see P70

...
# CODED-CONST parameters are used in a request, if the user shall not change its value, for example SID(service identifier)
# diag_coded_type provides information how to put the given value into the PDU

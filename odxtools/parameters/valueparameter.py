...
# for details, see P69
# reference a dop, which converts a value from coded into physical representation and vice versa
# in request, physical_default_value can define the default value to be sent to the ECU
# in response, physical_default_value used for verification of the received value, in this case, the received value shall be converted into the
# physical representation, and then compare them

...
# The parameter of type SYSTEM is used to cause the D-server to calculate a value that depends on the run
# time information (e.g. the current system time) or on the special D-server information (e.g. the tester ID).
